...
QT_MOC_LITERAL(1, 10, 18), // "indexStatusChanged"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 5) // "index"

    },
    "ItemModel\0indexStatusChanged\0\0index"
};
...
void ItemModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->indexStatusChanged((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (ItemModel::*_t)(const QModelIndex & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ItemModel::indexStatusChanged)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void ItemModel::indexStatusChanged(const QModelIndex & _t1)
{
